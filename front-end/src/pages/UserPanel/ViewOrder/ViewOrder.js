  ...
  return (
    <>
      {isLoading && (
        <div className="col-9">
          <span className="mt-4">
            سفارش #1234 در تاریخ {orderInfos.createdAt.slice(0,10)} ثبت شده است و در حال حاضر در وضعیت تکمیل
            شده می باشد.
          </span>
          ...
          <button className="btn btn-success btn-lg fs-4 mt-5">سفارش دوباره</button>
        </div>
      )}
    </>
  )
